...
const Header = () => {
  return (
    <header className="fixed top-0 left-1/2 -translate-x-1/2 w-full max-w-[420px] h-14 z-50 flex items-center justify-between px-4 backdrop-blur-md bg-background/70">
