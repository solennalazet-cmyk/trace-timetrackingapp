...
const StartPage = () => {
  ...
  return (
    <div className="flex flex-col items-center pt-4">
      <Seo title={"Trace — Time Tracker for Freelancers"} description={"Start a timer in one tap and assign work to accounts later. Trace is the timer-first time tracking app for freelancers."} path={"/"} />
